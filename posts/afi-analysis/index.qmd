...
by [Caleb J. Picker](https://calebjpicker.quarto.pub/ "Caleb J. Picker's Curriculum Vitae"), created using Quarto in RStudio

[Sing the Sorrow](https://open.spotify.com/album/1eIzVBHA5NvX0wo2nLACew?si=ntAoYywYSq-SrfJCGL9t3g) is my favorite album of all time. I've listened to it 1000s of times over the last 20 years since its release on March 11, 2003. If you're like me, and you love AFI as much as I do, then you likely also love the rest of their discography. And if you're really like me, then you also love data science, research, and statistics.
...
In this section, I calculate the most frequently used words, show a wordcloud, and then I show the top 10 most frequently used words by major album release.

I used the Lyrics Genius API wrapper in the `geniusr` package to download AFI's entire catalog of songs (following <https://www.r-bloggers.com/2021/01/scraping-analysing-and-visualising-lyrics-in-r/>).
...
Following on the theme, let's look at [Sing the Sorrow](https://open.spotify.com/album/1eIzVBHA5NvX0wo2nLACew?si=B4jg7hxoQtWYO2K-ITYDBQ) (the blood-red album in the second row, second column). The top 6 words are `grey`, `tonight`, `dance`, `step`, `lay`, `inside`, and `heart`. Grey likely comes from [This Celluloid Dream](https://open.spotify.com/track/46Y9yh2KxmtodypW4bCp6v?si=172d233902574ce7) ("All the colors (all grey) upon leaving (all grey) all will turn to grey.")
...
Next, I imported all the .txt files (one .txt file is one song) to make a collection of documents called a corpus. I set the minimum global frequency to 1.75. There are `r TDM_summary_terms` vocabulary words and `r TDM_summary_docs` songs. After that, I created several matrices that have song loadings and document loadings (similar to factor analysis). Next I present the song loadings and then the factor loadings--the song loadings uncover the hidden themes and the document loadings uncover which songs are related to a hidden factor.
...
Here, I will present all `r tk2_numfactors` from the analysis, but I will only analyze three of the hidden themes. In my estimation, the hidden themes aren't so straightforward, so some help interpreting them would be welcomed!
...
This next table extracts the top 5 words (and their loadings) for each of the `r tk2_numfactors` themes to make interpretation easier.
...
### Hidden Theme 2: Death's Sweet Caress {data-link="Hidden Theme 2: Death's Sweet Caress"}
...
AFI is my favorite band of all time, and [Sing the Sorrow](https://open.spotify.com/album/1eIzVBHA5NvX0wo2nLACew?si=ntAoYywYSq-SrfJCGL9t3g) is my favorite album of all time. Combined with my love for statistics, I decided to do a first go-around of analyzing the content of AFI's lyrics across their major album releases. Therefore, I excluded EPs, Deluxe Editions, Vinyls, and so on. I found some interesting stuff.

In addition to my goal of learning new data science skills for my [CV](https://calebjpicker.quarto.pub/cvr/), I wanted to gain a deeper understanding of the hidden themes and word usage patterns in Davey's lyrics. Although not every interpretation was straightforward, I did find that the most frequently used words were "feel" and "love". I also found that "eye"s were more closely related to memory words, such as "recal", "rememb", and "recogn", than to "sight". In addition, [This Celluloid Dream](https://open.spotify.com/album/1eIzVBHA5NvX0wo2nLACew?highlight=spotify:track:46Y9yh2KxmtodypW4bCp6v){style="font-size: 11pt;"} was most closely related to one of AFI's newest songs [Twisted Tongues](https://www.youtube.com/watch?v=_3ezOSq5QXk){style="font-size: 11pt;"}.

After finding the most frequent words and looking at how words were related to each other, I found hidden metaphors: such as love is blood ([Hidden Theme 1: Love is Red Blood]) comfort in but untrusting of death ([Hidden Theme 2: Death's Sweet Caress]), and distorted memories of his "star" ([Hidden Theme 3: Bathed in Your Radiance I Melt]).

Overall, this was a fun exercise. It's my first time doing something like this, and I certainly learned a lot! I know I still have a lot more to learn, especially regarding best software development practice. Nevertheless, I can hardly wait to attend the 20th Anniversary Sing the Sorrow event! For real. I've been in The Despair Faction fan club for 20 years. This is a real treat. You could say I've been waiting 20 years for this!
